...
If you choose ntpd, it's best to go with the NTPsec version rather than
legacy ntpd.  (As of June 2018 NTPsec is not yet available in binary
package form on all common distributions. You may have to build it
from source.) NTPsec shares some maintainers with GPSD, and has some
...
It change may require several hours for ntpd to converge with the new
