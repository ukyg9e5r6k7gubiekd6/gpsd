...
test3 = [
    ...
    (-27.1127, -109.3497, -6.05, "Easter Island"),
    # Kalahar: EGM2008 27.6676, EGM96 27.6659, EGM84 27.1081
    (-25.5920, 21.0937, 27.31,  "Kalahari Desert"),
    # Greenland: EGM2008 40.3981, EGM96 40.5912, EGM84 41.7056
    (71.7069, -42.6043, 39.48, "Greenland"),
    # Kuk Swamp: EGM2008 82.3395, EGM96 82.6719, EGM84 79.2188
    (-5.7837, 144.3317, 70.65, "Kuk Swamp PG"),
    # KBDN: EGM2008 -20.3509, EGM96 -19.8008, EGM84 -18.5562
    (44.094556, -121.200222, -21.23, "Bend Airport, OR (KBDN)"),
    # PANC: EGM2008 7.6508, EGM96 7.8563, EGM84 8.0838
    (61.171333, -149.991164, 12.55, "Anchorage Airport, AK (PANC)"),
    # KDEN: EGM2008 -18.1941, EGM96 -18.4209, EGM84 -15.9555
    (39.861666, -104.673166, -21.64, "Denver Airport, CO (KDEN)"),
    # KDEN: EGM2008 46.4499, EGM96 46.3061, EGM84 47.7620
    (51.46970, -0.45943, 46.06, "London Heathrow Airport, UK (LHR)"),
    # SCPE: EGM2008 37.9575, EGM96 39.3446, EGM84 46.6672
    (-22.92170, -68.158401, 32.37, "San Pedro de Atacama Airport, CL (SCPE)"),
    # SIN: EGM2008 8.6453, EGM96 8.3503, EGM84 8.2509
    (1.350190, 103.994003, 6.55, "Singapore Changi Airport, SG (SIN)"),
